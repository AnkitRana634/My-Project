            ...
            <div class="form-group" style="background-color:lightgray">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <asp:DropDownList ID="DDLSCat" Width="80%" CssClass="form-control" runat="server"></asp:DropDownList>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="Id" HeaderText="Id" />
                                <asp:BoundField DataField="Catname" HeaderText="Parent Category" />
                                <asp:BoundField DataField="ScatName" HeaderText="Sub Category" />
                                <asp:BoundField DataField="Pname" HeaderText="Product Name" />
                                <asp:BoundField DataField="price" HeaderText="Price" />
                                <asp:BoundField DataField="qty" HeaderText="Quantity" />
                                <asp:ImageField HeaderText="Product Image" DataImageUrlField="imgthumb" DataImageUrlFormatString="~/ProductImg/{0}">
